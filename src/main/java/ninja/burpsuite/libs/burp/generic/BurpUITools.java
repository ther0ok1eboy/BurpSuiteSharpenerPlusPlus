...
public class BurpUITools {
    public enum MainTabs {
        ...
        AutoDecoder("Extension:autoDecoder"),
        HaE("Extension:HaE"),
        Knife("Extension:Knife"),
        AppletPentester("Extension:AppletPentester"),
        JsonpHunter("Extension:JsonpHunter"),
        CaptchaDos("Extension:CaptchaDos"),
        XiaSQL("Extension:xia SQL"),
        XiaYue("Extension:xia Yue"),
        XiaLiao("Extension:xia Liao"),
        CaptchaKiller("Extension:captcha-killer-modified"),
        AwesomeTLS("Extension:Awesome TLS")
        ;
